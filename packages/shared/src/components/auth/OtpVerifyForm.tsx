...
interface OtpVerifyFormProps {
  ...
  onSuccess: () => void;
  /**
   * App-specific work to run right after a successful verify (before `onSuccess`), e.g. the
   * customer app merges the guest cart. Keeps this shared form free of app-only dependencies.
   */
